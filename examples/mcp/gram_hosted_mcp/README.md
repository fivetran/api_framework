...
1. **Visit the installation page**: [https://app.getgram.ai/mcp/fivetran-services-fivetran-api-mcp/install](https://app.getgram.ai/mcp/fivetran-servics-fivetran-api-mcp/install)
