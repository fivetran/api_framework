...
```mermaid
graph TB
    Sources["📊 Data Sources<br/>SaaS Apps | Databases | APIs | Files"]
    FivetranAI["🤖 Fivetran + AI<br/>Intelligent Connectors | Schema Mapping | Performance Optimization"]
    Warehouse["💾 Data Warehouse<br/>Snowflake | BigQuery | Databricks | Redshift"]
    Analytics["📈 Analytics Layer<br/>dbt + AI | BI Tools | ML Platforms"]
    Intelligence["🎯 AI Intelligence<br/>Data Quality | Insights | Optimization"]

    Sources -->|"Automated Ingestion"| FivetranAI
    FivetranAI -->|"Validated & Optimized"| Warehouse
    Warehouse -->|"Transformed Data"| Analytics
    Warehouse -.->|"AI Analysis"| Intelligence
    Analytics -.->|"AI Analysis"| Intelligence

    style Sources fill:#2196F3,stroke:#0d47a1,stroke-width:3px,color:#fff
    style FivetranAI fill:#9C27B0,stroke:#4a148c,stroke-width:4px,color:#fff
    style Warehouse fill:#4CAF50,stroke:#1b5e20,stroke-width:3px,color:#fff
    style Analytics fill:#FF9800,stroke:#e65100,stroke-width:3px,color:#fff
    style Intelligence fill:#E91E63,stroke:#880e4f,stroke-width:3px,color:#fff
```
